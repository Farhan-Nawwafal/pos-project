...
[$__name, $__params] = $__split('self-order.components.page-title-nav', ['title' => 'Edit Profil','hasBack' => true,'hasFilter' => false]);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2898809289-0', $__key);
...
<?php endif; ?>
            ...
            <div>
                ...
                <select
                    ...
                    aria-invalid="<?php echo e($errors->has('province') ? 'true' : 'false'); ?>"
                    aria-describedby="<?php echo e($errors->has('province') ? 'error-province' : ''); ?>"
                    class="mt-1 w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 text-sm focus:border-primary-60 focus:ring-2 focus:ring-primary-20">
...
<?php endif; ?>
            ...
            <div>
                ...
                <select
                    ...
                    <?php if(empty($province)): ?> disabled <?php endif; ?>
                    aria-invalid="<?php echo e($errors->has('regency') ? 'true' : 'false'); ?>"
                    aria-describedby="<?php echo e($errors->has('regency') ? 'error-regency' : ''); ?>"
...
<?php endif; ?>
            ...
            <div>
                ...
                <select
                    ...
                    <?php if(empty($province) || empty($regency)): ?> disabled <?php endif; ?>
                    aria-invalid="<?php echo e($errors->has('district') ? 'true' : 'false'); ?>"
                    aria-describedby="<?php echo e($errors->has('district') ? 'error-district' : ''); ?>"
                    class="mt-1 w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 text-sm focus:border-primary-60 focus:ring-2 focus:ring-primary-20 disabled:opacity-60">
                ...
                <?php if (isset($component)) { $__componentOriginalee90cf1aab8b8cee8674701eaf7a143f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee90cf1aab8b8cee8674701eaf7a143f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.common.input-error','data' => ['for' => 'district']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('common.input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'district']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\livewire\self-order\members\profile-edit.blade.php ENDPATH**/ ?>