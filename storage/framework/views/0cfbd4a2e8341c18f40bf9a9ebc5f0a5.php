<div>
    <aside id="sidebar"
        class="fixed flex flex-col mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-[1000] border-r border-gray-200 shadow-2xl shadow-black/10 dark:shadow-black/20 overflow-hidden"
        x-data="{
            openSubmenus: {},
            init() {
        ...
        :class="{
            'lg:w-[90px] lg:translate-x-0': !$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar
                .isMobileOpen,
        ...
        <div class="flex flex-1 min-h-0 flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
            ...
            <div class="mt-6 pt-4 pb-2 border-t border-gray-200 dark:border-gray-800">
                <!-- Profile Header - No hover effects -->
                <div class="flex items-center gap-3 p-3 rounded-xl">
                    <div class="flex-shrink-0">
                        <svg class="w-8 h-8 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                        ...
                        <p class="font-semibold text-sm text-gray-900 truncate dark:text-white">
                ...
                <div class="mt-3 px-3">
                    ...
                    <button type="button" wire:click="processEndShift"
                        ...
                        class="relative group w-full flex items-center justify-center gap-2 py-2 px-3 text-sm font-semibold text-orange-600 bg-orange-50 rounded-lg hover:bg-orange-100 border border-orange-200 transition-colors dark:bg-orange-500/10 dark:text-orange-400 dark:border-orange-500/30 dark:hover:bg-orange-500/20"
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>" class="mt-4 px-3">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
                        class="w-full flex items-center justify-center gap-2 py-2 px-3 text-sm font-medium text-red-600 rounded-lg hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\layouts\sidebar.blade.php ENDPATH**/ ?>