<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-2">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('promotions.manage')): ?>
                <a href="<?php echo e(route('promotions.create')); ?>" wire:navigate
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.01] transition-colors">
                            <td class="px-5 py-4">
                                <div class="space-y-1">
                                    <p class="text-sm font-medium text-gray-800 dark:text-white/90"><?php echo e($p->name); ?>

                                    </p>
                                    <span
                                        class="inline-flex rounded-full px-2 py-0.5 text-theme-xs font-medium <?php echo e($isRunning ? 'bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500' : 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400'); ?>">
                                        <?php echo e($isRunning ? 'Sedang Berjalan' : ($p->is_active ? 'Aktif (Menunggu)' : 'Nonaktif')); ?>
                            ...
                            <td class="px-5 py-4 text-sm text-gray-800 dark:text-white/90">
                                <span
                                    class="rounded-sm px-2 py-0.5 text-xs font-medium <?php echo e($p->type === 'public' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'); ?>">
                            ...
                            <td class="px-5 py-4 text-sm text-gray-800 dark:text-white/90">
                                <div class="text-xs space-y-0.5">
                                    <p><span class="text-gray-400">Mulai:</span>
                                        <?php echo e($p->start_date ? $p->start_date->format('d M Y H:i') : '-'); ?></p>
                                    <p><span class="text-gray-400">Selesai:</span>
                                        <?php echo e($p->end_date ? $p->end_date->format('d M Y H:i') : '-'); ?></p>
                                </div>
                            </td>
                            <td class="px-5 py-4 text-sm text-gray-800 dark:text-white/90">
                                <p class="text-xs">Min. Belanja: <span class="font-medium">Rp
                                        <?php echo e(number_format($p->min_subtotal, 0, ',', '.')); ?></span></p>
                            </td>
                            <td class="px-5 py-4 text-sm text-gray-800 dark:text-white/90 font-medium">
                                <?php echo e($p->discount_label); ?>

                            </td>
                            <td class="px-5 py-4 text-sm text-gray-600 dark:text-gray-400">
                                <?php echo e($p->payment_method ?? 'Semua Metode'); ?>

                            </td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('promotions.manage')): ?>
                                <td class="px-5 py-4 text-right">
                                    <div class="inline-flex items-center gap-2">
                                        <a href="<?php echo e(route('promotions.edit', ['promotion' => $p->id])); ?>" wire:navigate
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.common.empty-table-row','data' => ['colspan' => '7','message' => 'Belum ada data promosi tersedia.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['colspan' => '7','message' => 'Belum ada data promosi tersedia.']); ?>
...
<?php endif; ?>
        ...
        <div class="border-t border-gray-200 px-5 py-4 dark:border-gray-800">
            <?php echo e($promotions->links('livewire.pagination.admin')); ?>

        </div>
    </div>
</div>
<?php /**PATH D:\farhan\projects\freelance\pos-restoran-v2\resources\views/components/promotions/promotions-page.blade.php ENDPATH**/ ?>