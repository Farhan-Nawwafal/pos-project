        ...
        <div class="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <div class="rounded-xl bg-gray-50/50 p-3 dark:bg-gray-900/50">
                ...
                <h4 class="text-xl font-black text-gray-800 dark:text-white/90 mt-1">
                    Rp<?php echo e(number_format((int) $grossAmount, 0, ',', '.')); ?>
...
<?php /**PATH D:\farhan\project-freelance\pos-restoran-v2\resources\views/components/ecommerce/ecommerce-metrics.blade.php ENDPATH**/ ?>