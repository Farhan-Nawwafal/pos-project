<div class="grid grid-cols-1 gap-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white/90">Sales Recapitulation</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Sales Overview</p>
        </div>
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.common.date-range-picker-transaction','data' => ['from' => $fromDate,'to' => $toDate,'wireFromModel' => 'fromDate','wireToModel' => 'toDate','class' => 'flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['from' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($fromDate),'to' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($toDate),'wire-from-model' => 'fromDate','wire-to-model' => 'toDate','class' => 'flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center']); ?>
...
</div><?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views/livewire/transactions/transactions-page.blade.php ENDPATH**/ ?>