            ...
            <div class="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                <div class="relative flex-1 xl:flex-none">
                    ...
                    <input wire:model.live.debounce.400ms="search" type="text"
                        ...
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-4 pl-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[340px] xl:min-w-[340px] dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                </div>
...
<?php endif; ?>
                ...
                <table class="w-full table-auto">
                    <thead>
                        <tr class="border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50">
                            ...
                            <th class="px-5 py-4 text-center text-xs font-medium text-gray-500 uppercase">Perubahan Qty
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
    ...
    <?php if (isset($component)) { $__componentOriginale6dc7a7fa0f91f78c1fa5f80a0a6cab2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale6dc7a7fa0f91f78c1fa5f80a0a6cab2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pos-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale6dc7a7fa0f91f78c1fa5f80a0a6cab2)): ?>
<?php $attributes = $__attributesOriginale6dc7a7fa0f91f78c1fa5f80a0a6cab2; ?>
<?php unset($__attributesOriginale6dc7a7fa0f91f78c1fa5f80a0a6cab2); ?>
<?php endif; ?>
<?php if (isset($__componentOriginale6dc7a7fa0f91f78c1fa5f80a0a6cab2)): ?>
<?php $component = $__componentOriginale6dc7a7fa0f91f78c1fa5f80a0a6cab2; ?>
<?php unset($__componentOriginale6dc7a7fa0f91f78c1fa5f80a0a6cab2); ?>
<?php endif; ?>
</div>
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views/livewire/transactions/transactions-page.blade.php ENDPATH**/ ?>