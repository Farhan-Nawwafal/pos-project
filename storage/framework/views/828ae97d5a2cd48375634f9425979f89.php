<div class="space-y-6">
    <?php
        ...
        $canViewStore =
            $canEditAll ||
            (auth()->user()?->can('settings.store.view') ?? false) ||
            (auth()->user()?->can('settings.store.edit') ?? false);
        $canEditStore = $canEditAll || (auth()->user()?->can('settings.store.edit') ?? false);

        $canViewPrinters =
            $canEditAll ||
            (auth()->user()?->can('settings.printers.view') ?? false) ||
            (auth()->user()?->can('settings.printers.edit') ?? false);
        $canEditPrinters = $canEditAll || (auth()->user()?->can('settings.printers.edit') ?? false);

        $canViewSystem =
            $canEditAll ||
            (auth()->user()?->can('settings.system.view') ?? false) ||
            (auth()->user()?->can('settings.system.edit') ?? false);
        $canEditSystem = $canEditAll || (auth()->user()?->can('settings.system.edit') ?? false);

        $canViewPoints =
            $canEditAll ||
            (auth()->user()?->can('settings.points.view') ?? false) ||
            (auth()->user()?->can('settings.points.edit') ?? false);
        $canEditPoints = $canEditAll || (auth()->user()?->can('settings.points.edit') ?? false);

        $canViewTargets =
            $canEditAll ||
            (auth()->user()?->can('settings.targets.view') ?? false) ||
            (auth()->user()?->can('settings.targets.edit') ?? false);
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Kelola konfigurasi toko, pajak, pembayaran, dan printer.
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                <div class="space-y-2 p-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canViewStore): ?>
                        <button type="button" wire:click="setSection('store')" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            'bg-white text-gray-700 border-gray-200 hover:bg-gray-50 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-800 dark:hover:bg-white/[0.03]' =>
                                $activeSection !== 'store',
                        ]); ?>">
                            Pengaturan Toko
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canViewPrinters): ?>
                        <button type="button" wire:click="setSection('printers')" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            Sumber Printer
                            <p class="mt-1 text-xs font-normal opacity-90">Kelola kategori printer dan setup perangkat.
                            </p>
                        </button>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canViewTargets): ?>
                        <button type="button" wire:click="setSection('targets')" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            Target Bulanan
                            <p class="mt-1 text-xs font-normal opacity-90">Target pendapatan per bulan untuk analisa.
                            </p>
                        </button>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <div class="lg:col-span-9">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$canViewAnySection): ?>
                <div
                    class="overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 text-sm text-gray-700 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-300">
            ...
            <?php elseif($activeSection === 'store'): ?>
                <div
                    ...
                    <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Informasi toko, pajak, dan biaya layanan.
                        </p>
                    </div>
                            ...
                            <div class="md:col-span-8">
                                <div class="space-y-5">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            <label
                                                class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Nama
                                                Toko</label>
                                            <input wire:model.live="store_name" type="text"
                                                <?php echo e($canEditStore ? '' : 'disabled'); ?>
                                                ...
                                                placeholder="<?php echo e(config('app.name')); ?>" />
...
<?php endif; ?>
                                        ...
                                        <div>
                                            <label
                                                class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Telepon</label>
                                    ...
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            <label
                                                ...
                                                PB1 (%)</label>
                                            <input wire:model.live="tax_rate" type="number" step="0.01"
                                                min="0" max="100" <?php echo e($canEditStore ? '' : 'disabled'); ?>
...
<?php endif; ?>
                                        ...
                                        <div>
                                            <label
                                                ...
                                                Charge (%)</label>
                                            <input wire:model.live="service_rate" type="number" step="0.01"
                                                min="0" max="100" <?php echo e($canEditStore ? '' : 'disabled'); ?>

                                                class="dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                                            <?php if (isset($component)) { $__componentOriginalee90cf1aab8b8cee8674701eaf7a143f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee90cf1aab8b8cee8674701eaf7a143f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.common.input-error','data' => ['for' => 'service_rate']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('common.input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'service_rate']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <label
                                            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Alamat</label>
                                        <textarea wire:model.live="address" rows="3" <?php echo e($canEditStore ? '' : 'disabled'); ?>

                                            class="dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm text-gray-800 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"></textarea>
                                        <?php if (isset($component)) { $__componentOriginalee90cf1aab8b8cee8674701eaf7a143f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee90cf1aab8b8cee8674701eaf7a143f = $attributes; } ?>
...
<?php endif; ?>
                                ...
                                <div
                                    class="mt-5 rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900">
                                    <div class="flex items-start justify-between gap-4">
                                        <div>
                                            <p class="text-sm font-semibold text-gray-800 dark:text-white/90">Payment
                                                Gateway</p>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Mengaktifkan
                                                pembayaran online bila sudah dikonfigurasi.</p>
                                        </div>
                                        <label class="inline-flex cursor-pointer items-center gap-2">
                                            <input wire:model.live="payment_gateway_enabled" type="checkbox"
                                                <?php echo e($canEditStore ? '' : 'disabled'); ?>

                                                class="h-5 w-5 rounded border-gray-300 text-brand-600 focus:ring-brand-500/20 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-700 dark:bg-gray-900" />
                                            <span
                                                class="text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo e($payment_gateway_enabled ? 'Aktif' : 'Nonaktif'); ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-4">
                                <div
                                    class="space-y-3 rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->storeLogoUrl()): ?>
                                        <div
                                            class="flex items-center justify-center rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900">
                                            <img src="<?php echo e($this->storeLogoUrl()); ?>" alt="Logo"
                                                class="h-24 w-24 rounded-xl object-cover" />
                                        </div>
                                    <?php else: ?>
                                        <div
                                            class="flex items-center justify-center rounded-xl border border-dashed border-gray-300 bg-gray-50 p-6 text-sm text-gray-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                            Belum ada logo
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div>
                                        <input wire:model="store_logo_upload" type="file" accept="image/*"
                                            <?php echo e($canEditStore ? '' : 'disabled'); ?>

                                            class="block w-full text-sm text-gray-600 disabled:cursor-not-allowed disabled:opacity-60 file:mr-4 file:rounded-lg file:border-0 file:bg-brand-500 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-brand-600 dark:text-gray-300" />
                                        <?php if (isset($component)) { $__componentOriginalee90cf1aab8b8cee8674701eaf7a143f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee90cf1aab8b8cee8674701eaf7a143f = $attributes; } ?>
            ...
            <?php elseif($activeSection === 'printers'): ?>
                <div
                    ...
                    <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Kelola daftar sumber printer dan setup
                            perangkat per sumber.</p>
                    </div>
...
<?php endif; ?>
                        ...
                        <form wire:submit="savePrinterSettings"
                            ...
                            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Atur apakah logo toko
                                        dicetak pada struk tipe kasir.</p>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditPrinters): ?>
                                    <button type="submit"
                                        class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 inline-flex h-10 items-center justify-center rounded-lg px-4 text-xs font-semibold text-white transition">
                                        Simpan
                                    </button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="mt-3">
                                <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                    <input wire:model.live="cashier_receipt_print_logo" type="checkbox"
                                        <?php echo e($canEditPrinters ? '' : 'disabled'); ?>
...
<?php endif; ?>
                        ...
                        <div
                            ...
                            <div
                                class="flex flex-col justify-between gap-4 border-b border-gray-200 px-5 py-4 lg:flex-row lg:items-center dark:border-gray-800">
                                <form wire:submit="createPrinterSource"
                                    class="grid w-full grid-cols-1 gap-3 lg:w-auto lg:grid-cols-6 lg:items-end">
                                    <div class="lg:col-span-3">
                                        <label
                                            class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Nama</label>
                                        <input wire:model.live="printerName" type="text"
                                            aria-invalid="<?php echo e($errors->has('printerName') ? 'true' : 'false'); ?>"
                                            aria-describedby="<?php echo e($errors->has('printerName') ? 'error-printerName' : ''); ?>"
                                            <?php echo e($canEditPrinters ? '' : 'disabled'); ?>
...
<?php endif; ?>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <select wire:model.live="printerType"
                                            aria-invalid="<?php echo e($errors->has('printerType') ? 'true' : 'false'); ?>"
                                            aria-describedby="<?php echo e($errors->has('printerType') ? 'error-printerType' : ''); ?>"
                                            <?php echo e($canEditPrinters ? '' : 'disabled'); ?>

                                            class="dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
...
<?php endif; ?>
                                    ...
                                    <div class="lg:col-span-1">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditPrinters): ?>
                                            <button type="submit"
                                                class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 inline-flex h-11 w-full items-center justify-center rounded-lg px-4 text-sm font-semibold text-white transition">
                                                Tambah
                                            </button>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    ...
                                    <thead>
                                        <tr class="border-b border-gray-200 dark:divide-gray-800 dark:border-gray-800">
                                            ...
                                            <th
                                                ...
                                                Tipe</th>
                                            <th
                                                class="px-5 py-4 text-right text-xs font-medium text-gray-500 dark:text-gray-400">
                                                Dipakai Produk</th>
                                            <th
                                                class="px-5 py-4 text-right text-xs font-medium text-gray-500 dark:text-gray-400">
                                                Aksi</th>
                                            ...
                                            <tr>
                                                <td class="px-5 py-4">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing): ?>
                                                        <input wire:model.live="editingPrinterName" type="text"
                                                            aria-invalid="<?php echo e($errors->has('editingPrinterName') ? 'true' : 'false'); ?>"
                                                            aria-describedby="<?php echo e($errors->has('editingPrinterName') ? 'error-editingPrinterName' : ''); ?>"
                                                            class="dark:bg-dark-900 shadow-theme-xs h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                                                        <?php if (isset($component)) { $__componentOriginalee90cf1aab8b8cee8674701eaf7a143f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee90cf1aab8b8cee8674701eaf7a143f = $attributes; } ?>
...
<?php endif; ?>
                                                    <?php else: ?>
                                                        <p
                                                            ...
                                                            <?php echo e($source->name); ?></p>
                                                        <p class="text-xs text-gray-500 dark:text-gray-400">
                                                            source-<?php echo e((int) $source->id); ?></p>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </td>
                                                <td class="px-5 py-4">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing): ?>
                                                        <input wire:model.live="editingPrinterType" type="text"
                                                            aria-invalid="<?php echo e($errors->has('editingPrinterType') ? 'true' : 'false'); ?>"
                                                            aria-describedby="<?php echo e($errors->has('editingPrinterType') ? 'error-editingPrinterType' : ''); ?>"
                                                            class="dark:bg-dark-900 shadow-theme-xs h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                                                        <?php if (isset($component)) { $__componentOriginalee90cf1aab8b8cee8674701eaf7a143f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee90cf1aab8b8cee8674701eaf7a143f = $attributes; } ?>
...
<?php endif; ?>
                                                    <?php else: ?>
                                                        <p class="text-sm text-gray-800 dark:text-white/90">
                                                            <?php echo e($source->type); ?></p>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </td>
                                                <td class="px-5 py-4 text-right">
                                                    <p class="text-sm text-gray-800 dark:text-white/90">
                                                        <?php echo e(number_format((int) ($source->products_count ?? 0), 0, ',', '.')); ?>
                                                ...
                                                <td class="px-5 py-4 text-right">
                                                    <div class="inline-flex items-center gap-2">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing): ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditPrinters): ?>
                                                                <button type="button"
                                                                    wire:click="updatePrinterSource"
                                                                    class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 inline-flex items-center justify-center rounded-lg px-3 py-2 text-xs font-semibold text-white transition">
                                                                    Simpan
                                                                </button>
                                                                <button type="button"
                                                                    wire:click="cancelEditPrinterSource"
                                                                    class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                                                    Batal
                                                                </button>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php else: ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditPrinters): ?>
                                                                <button type="button"
                                                                    wire:click="startEditPrinterSource(<?php echo e((int) $source->id); ?>)"
                                                                    class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                                                    Edit
                                                                </button>
                                                                <button type="button"
                                                                    x-on:click.prevent="$dispatch('confirm', { message: 'Hapus sumber printer ini?', method: 'deletePrinterSource', args: [<?php echo e((int) $source->id); ?>] })"
                                                                    class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                                                    Hapus
                                                                </button>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditPrinters): ?>
                            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]"
                                x-data="printerSystem">
                                <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                        <div>
                                            <h4 class="text-base font-semibold text-gray-800 dark:text-white/90">Setup
                                                Perangkat Printer</h4>
                                            <p class="text-sm text-gray-500 dark:text-gray-400">Konfigurasi printer
                                                Bluetooth untuk setiap sumber.</p>
                                        </div>
                                        <button type="button" @click="isOpen = !isOpen"
                                            class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                ...
                                <div x-show="isOpen" x-cloak class="space-y-4 p-5">
                                    <div
                                        class="rounded-xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                                        Setup printer membutuhkan browser yang mendukung Web Bluetooth (umumnya Chrome).
                                        Pastikan printer menyala dan berada dekat perangkat.
                                    </div>
                                            ...
                                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                                <template x-for="(cfg, role) in printers" :key="role">
                                                    <tr>
                                                        ...
                                                        <td class="px-5 py-4">
                                                            <p class="text-sm text-gray-800 dark:text-white/90"
                                                                x-text="cfg.deviceName"></p>
                                                            <p class="text-xs text-gray-500 dark:text-gray-400"
                                                                x-text="cfg.type"></p>
                                                        </td>
                                                        <td class="px-5 py-4 whitespace-nowrap">
                                                            <span class="rounded-full px-3 py-1 text-xs font-semibold"
                                                                :class="cfg.status === 'Terhubung' ?
                                                        ...
                                                        <td class="px-5 py-4 text-right">
                                                            <div class="inline-flex items-center gap-2">
                                                                <button type="button" @click="setup(role)"
                                                                    class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 inline-flex items-center justify-center rounded-lg px-3 py-2 text-xs font-semibold text-white transition">
                                                                    Setup
                                                                </button>
                                                                <button type="button" @click="testPrint(role)"
                                                                    class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                                                    Test
                                                                </button>
                                                                <button type="button" @click="forget(role)"
                                                                    class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                                                    Lupa
                                                                </button>
                                                            </div>
            ...
            <?php elseif($activeSection === 'system'): ?>
                <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'settings-section-system'; ?>wire:key="settings-section-system"
                    class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                    ...
                    <form <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'settings-form-system'; ?>wire:key="settings-form-system" wire:submit="saveSystemSettings" class="space-y-5 p-5">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                <label
                                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Pembulatan
                                    Total</label>
                                <input wire:model.live="rounding_base" type="number" min="0" step="1"
                                    aria-invalid="<?php echo e($errors->has('rounding_base') ? 'true' : 'false'); ?>"
                                    aria-describedby="<?php echo e($errors->has('rounding_base') ? 'error-rounding_base' : ''); ?>"
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Isi 100 untuk pembulatan ke
                                    100 terdekat. Isi 0 untuk mematikan pembulatan.</p>
                            </div>

                            <div>
                                <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Nama
                                    Default Pelanggan</label>
                                <input wire:model.live="pos_default_customer_name" type="text"
                                    aria-invalid="<?php echo e($errors->has('pos_default_customer_name') ? 'true' : 'false'); ?>"
                                    aria-describedby="<?php echo e($errors->has('pos_default_customer_name') ? 'error-pos_default_customer_name' : ''); ?>"
                                    <?php echo e($canEditSystem ? '' : 'disabled'); ?>
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Dipakai saat transaksi POS
                                    tanpa input nama.</p>
                            </div>

                            <div class="md:col-span-2">
                                <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Metode
                                    Pembayaran Default</label>
                                <select wire:model.live="pos_default_payment_method"
                                    aria-invalid="<?php echo e($errors->has('pos_default_payment_method') ? 'true' : 'false'); ?>"
                                    aria-describedby="<?php echo e($errors->has('pos_default_payment_method') ? 'error-pos_default_payment_method' : ''); ?>"
                                    <?php echo e($canEditSystem ? '' : 'disabled'); ?>
...
<?php endif; ?>
                        ...
                        <div
                            class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
                            <div class="mb-3">
                                <h4 class="text-base font-semibold text-gray-800 dark:text-white/90">Koreksi Transaksi
                                </h4>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Atur batasan cepat di POS dan
                                    kapan butuh approval (PIN).</p>
                            </div>

                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div
                                    class="md:col-span-2 rounded-xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                                    Approver ditentukan oleh permission: transactions.void.approve dan
                                    transactions.refund.approve. PIN diatur di Manajemen User.
                                </div>

                                <div class="md:col-span-2">
                                    <label
                                        class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                        <input wire:model.live="corrections_void_pending_requires_approval"
                                            type="checkbox" <?php echo e($canEditSystem ? '' : 'disabled'); ?>
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Jika nonaktif, transaksi
                                        pending bisa di-void cepat oleh role yang berhak.</p>
                                </div>

                                <div class="md:col-span-2">
                                    <label
                                        class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                        <input wire:model.live="corrections_refund_requires_approval_for_cash"
                                            type="checkbox" <?php echo e($canEditSystem ? '' : 'disabled'); ?>
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Disarankan aktif untuk
                                        mencegah penyalahgunaan kas.</p>
                                </div>

                                <div>
                                    <label
                                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Batas
                                        refund cepat tanpa approval (Rp)</label>
                                    <input x-data="currencyInput($wire.entangle('corrections_refund_quick_max_amount'))" x-model="displayValue" @input="handleInput"
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Refund di atas angka ini
                                        otomatis minta PIN.</p>
                                </div>

                                <div>
                                    <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Maks
                                        refund cepat per hari per kasir</label>
                                    <input wire:model.live="corrections_refund_quick_max_count_per_day" type="number"
                                        min="0" step="1"
                                        aria-invalid="<?php echo e($errors->has('corrections_refund_quick_max_count_per_day') ? 'true' : 'false'); ?>"
                                        aria-describedby="<?php echo e($errors->has('corrections_refund_quick_max_count_per_day') ? 'error-corrections_refund_quick_max_count_per_day' : ''); ?>"
                                        <?php echo e($canEditSystem ? '' : 'disabled'); ?>
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Jika sudah lewat, refund
                                        berikutnya minta PIN.</p>
                                </div>

                                <div>
                                    <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Maks
                                        void cepat per hari per kasir</label>
                                    <input wire:model.live="corrections_void_quick_max_count_per_day" type="number"
                                        min="0" step="1"
                                        aria-invalid="<?php echo e($errors->has('corrections_void_quick_max_count_per_day') ? 'true' : 'false'); ?>"
                                        aria-describedby="<?php echo e($errors->has('corrections_void_quick_max_count_per_day') ? 'error-corrections_void_quick_max_count_per_day' : ''); ?>"
                                        <?php echo e($canEditSystem ? '' : 'disabled'); ?>
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Jika sudah lewat, void
                                        berikutnya minta PIN (jika diizinkan).</p>
                                </div>

                                <div>
                                    <label
                                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Window
                                        void cepat (menit)</label>
                                    <input wire:model.live="corrections_void_quick_window_minutes" type="number"
                                        min="0" step="1"
                                        aria-invalid="<?php echo e($errors->has('corrections_void_quick_window_minutes') ? 'true' : 'false'); ?>"
                                        aria-describedby="<?php echo e($errors->has('corrections_void_quick_window_minutes') ? 'error-corrections_void_quick_window_minutes' : ''); ?>"
                                        <?php echo e($canEditSystem ? '' : 'disabled'); ?>
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Contoh 5 = void cepat
                                        hanya sampai 5 menit setelah transaksi dibuat. Isi 0 untuk mematikan.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Atur batas diskon per role dan
                                    kapan butuh approval (PIN).</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div class="md:col-span-2">
                                    <label
                                        class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                        <input wire:model.live="discount_applies_before_tax" type="checkbox"
                                            <?php echo e($canEditSystem ? '' : 'disabled'); ?>
...
<?php endif; ?>
            ...
            <?php elseif($activeSection === 'points'): ?>
                <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'settings-section-points'; ?>wire:key="settings-section-points"
                    class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                    ...
                    <form <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'settings-form-points'; ?>wire:key="settings-form-points" wire:submit="savePointSettings" class="space-y-5 p-5">
                        <div
                            class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
                            <div class="mb-3">
                                <h4 class="text-base font-semibold text-gray-800 dark:text-white/90">Earning
                                    (Mendapatkan Poin)</h4>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Atur berapa nilai transaksi
                                    untuk mendapatkan 1 poin.</p>
                            </div>

                            <div>
                                <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Rate
                                    Earning (Rp per 1 Poin)</label>
                                <input x-data="currencyInput($wire.entangle('point_earning_rate'))" x-model="displayValue" @input="handleInput"
                                    type="text" inputmode="numeric"
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Contoh: Isi 10000 artinya
                                    setiap belanja Rp 10.000 dapat 1 poin. Isi 0 untuk menonaktifkan earning.</p>
                            </div>
                        </div>
                        ...
                        <div
                            class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
                            <div class="mb-3">
                                <h4 class="text-base font-semibold text-gray-800 dark:text-white/90">Redemption
                                    (Penukaran Poin)</h4>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Atur nilai tukar poin menjadi
                                    diskon.</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div>
                                    <label
                                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Nilai 1
                                        Poin (Rp)</label>
                                    <input x-data="currencyInput($wire.entangle('point_redemption_value'))" x-model="displayValue" @input="handleInput"
                                        type="text" inputmode="numeric"
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Contoh: Isi 1 artinya 1
                                        poin bernilai diskon Rp 1.</p>
                                </div>

                                <div>
                                    <label
                                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Minimal
                                        Poin Ditukar</label>
                                    <input wire:model.live="min_redemption_points" type="number" min="0"
                                        step="1"
                                        aria-invalid="<?php echo e($errors->has('min_redemption_points') ? 'true' : 'false'); ?>"
                                        aria-describedby="<?php echo e($errors->has('min_redemption_points') ? 'error-min_redemption_points' : ''); ?>"
                                        <?php echo e($canEditPoints ? '' : 'disabled'); ?>
...
<?php unset($__componentOriginalee90cf1aab8b8cee8674701eaf7a143f); ?>
<?php endif; ?>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Member harus punya minimal
                                        poin segini untuk bisa menukar.</p>
                                </div>
                            </div>
                        </div>
            ...
            <?php elseif($activeSection === 'targets'): ?>
                <div
                    ...
                    <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Atur target pendapatan per bulan untuk
                            dashboard dan laporan.</p>
                    </div>
                    ...
                    <div class="space-y-5 p-5">
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-12">
                            <div class="md:col-span-5">
                                <label
                                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Bulan</label>
                                <select wire:model.live="monthlyTargetMonth"
                                    aria-invalid="<?php echo e($errors->has('monthlyTargetMonth') ? 'true' : 'false'); ?>"
                                    aria-describedby="<?php echo e($errors->has('monthlyTargetMonth') ? 'error-monthlyTargetMonth' : ''); ?>"
                                    <?php echo e($canEditTargets ? '' : 'disabled'); ?>

                                    class="dark:bg-dark-900 shadow-theme-xs h-11 w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2.5 pr-11 text-sm text-gray-700 focus:ring-3 focus:outline-hidden disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
...
<?php endif; ?>
                            ...
                            <div class="md:col-span-3">
                                <label
                                    class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Tahun</label>
                                <input wire:model.live="monthlyTargetYear" type="number" min="2000"
                                    max="2100" step="1"
                                    aria-invalid="<?php echo e($errors->has('monthlyTargetYear') ? 'true' : 'false'); ?>"
                                    aria-describedby="<?php echo e($errors->has('monthlyTargetYear') ? 'error-monthlyTargetYear' : ''); ?>"
                                    <?php echo e($canEditTargets ? '' : 'disabled'); ?>
...
<?php endif; ?>
                            ...
                            <div class="md:col-span-4">
                                ...
                                <div x-data="currencyInput($wire.entangle('monthlyTargetAmount'))">
                                    <input x-model="displayValue" @input="handleInput" type="text"
                                        inputmode="numeric"
                                        aria-invalid="<?php echo e($errors->has('monthlyTargetAmount') ? 'true' : 'false'); ?>"
                                        aria-describedby="<?php echo e($errors->has('monthlyTargetAmount') ? 'error-monthlyTargetAmount' : ''); ?>"
                                        <?php echo e($canEditTargets ? '' : 'disabled'); ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center justify-end gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditTargets): ?>
                                <button type="button" wire:click="saveMonthlyTarget"
                                    class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 inline-flex h-11 items-center justify-center rounded-lg px-5 text-sm font-semibold text-white transition">
                                    Simpan Target
                                </button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div
                            ...
                            <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">Klik baris untuk mengedit, atau
                                    hapus target bila tidak digunakan.</p>
                            </div>
                            <div class="custom-scrollbar overflow-x-auto">
                                <table class="w-full table-auto">
                                    <thead>
                                    ...
                                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $monthlyTargets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <tr class="<?php echo e($canEditTargets ? 'cursor-pointer hover:bg-gray-50 dark:hover:bg-white/[0.02]' : ''); ?>"
                                                <?php if($canEditTargets): ?> wire:click="selectMonthlyTarget(<?php echo e((int) ($row['year'] ?? 0)); ?>, <?php echo e((int) ($row['month'] ?? 0)); ?>)" <?php endif; ?>>
                                                <td class="px-5 py-4">
                                                ...
                                                <td class="px-5 py-4 text-right">
                                                    <p class="text-sm font-semibold text-gray-800 dark:text-white/90">
                                                        Rp
                                                        <?php echo e(number_format((int) ($row['amount'] ?? 0), 0, ',', '.')); ?>
...
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\livewire\settings\settings-page.blade.php ENDPATH**/ ?>