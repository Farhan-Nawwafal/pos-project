<div class="min-h-screen bg-gradient-to-b from-brand-25 via-white to-gray-50 px-4 py-8">
    <div class="mx-auto w-full max-w-md">
        <div class="flex items-center justify-between gap-3">
            ...
            >
                <img src="<?php echo e(asset('assets/icons/arrow-left-icon.svg')); ?>" alt="" class="mr-2 h-4 w-4" />
                Kembali
            </a>
            <a
                href="<?php echo e(url('/order/scan')); ?>"
...
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\livewire\self-order\scan.blade.php ENDPATH**/ ?>