    ...
    <header class="bg-white border-b border-gray-200">
        <div class="px-4 py-4">
            <div class="flex items-center gap-3">
                <a wire:navigate href="<?php echo e(route('self-order.start')); ?>" class="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-700 hover:bg-gray-50">
...
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\livewire\self-order\members\verify-email.blade.php ENDPATH**/ ?>