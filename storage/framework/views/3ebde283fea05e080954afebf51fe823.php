    ...
    <div class="mx-auto max-w-md min-h-screen font-poppins bg-gray-50 flex items-center justify-center px-4 py-12">
        <div class="w-full rounded-3xl overflow-hidden bg-white shadow-sm border border-gray-200">
            ...
            <div class="border-t border-gray-200 p-6 space-y-3">
                <a href="<?php echo e(route('self-order.payment.page')); ?>" wire:navigate class="flex w-full items-center justify-center gap-2 rounded-2xl bg-primary-60 hover:bg-primary-70 px-6 py-4 text-white font-bold text-sm">
                ...
                <a href="<?php echo e(route('self-order.payment.cart')); ?>" wire:navigate class="flex w-full items-center justify-center gap-2 rounded-2xl bg-white border-2 border-gray-200 hover:border-primary-40 px-6 py-4 text-gray-900 font-bold text-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('self-order.home')); ?>" wire:navigate class="flex w-full items-center justify-center gap-2 rounded-2xl bg-gray-50 hover:bg-gray-100 px-6 py-4 text-gray-900 font-bold text-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\livewire\self-order\payment\failure.blade.php ENDPATH**/ ?>