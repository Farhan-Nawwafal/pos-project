        ...
        <div
                    ...
                    <div class="w-full h-full overflow-auto">
                        <table class="w-full table-auto">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->salesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <?php
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="text-xs px-3 py-2 text-gray-800">
                                            <?php echo e($trx->additional_info ?? '-'); ?>
                    ...
                    <div
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shouldShow): ?>
                                <button type="button" wire:click.prevent="openSelectTableModal(<?php echo e((int) $t['id']); ?>)"
                                    <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'table-item-'.e($t['id']).''; ?>wire:key="table-item-<?php echo e($t['id']); ?>" x-data="{
                                        start: <?php echo e($hasTimer ? "new Date('$isoDate').getTime()" : 'null'); ?>,
                                        display: '00:00',
                                        timer: null,
                                        init() {
                                    ...
                                    <span
                                        class="font-bold group-hover:scale-105 transition-transform"><?php echo e($t['label']); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasTimer): ?>
            ...
            <div class="flex-shrink-0 pt-8">
                ...
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <!-- Group Waktu / Badge -->
                    <div class="flex items-center gap-2">
                        <span class="px-2.5 py-1 text-xs font-bold bg-yellow-400 text-white whitespace-nowrap">> 0
                            minute</span>
                        <span class="px-2.5 py-1 text-xs font-bold bg-[#DD4B39] text-white whitespace-nowrap">> 0
                            minute</span>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-14 gap-2 items-center">
                            ...
                            <div
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderType == 'dine_in' && $selectedTableId): ?>
                                    <input wire:model.live.debounce.300ms="additionalInfo" type="text"
                    ...
                    <div
                            ...
                            <div class="space-y-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="flex items-start gap-3"
                                        <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'cart-item-'.e($item['variant_id'] ?? ($item['product_id'] ?? $idx)).''; ?>wire:key="cart-item-<?php echo e($item['variant_id'] ?? ($item['product_id'] ?? $idx)); ?>">
                                        ...
                                        <div class="min-w-0 flex-1 flex justify-between items-start gap-2">
                                            ...
                                            <div class="flex items-center gap-2 shrink-0">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($item['quantity'] ?? 0) > 1): ?>
                                                    <button type="button"
                                                        wire:click="decrement(<?php echo e($idx); ?>)"
                                                        class="w-6 h-5 bg-gray-400 hover:bg-gray-500 text-white text-[10px] rounded-xs font-bold flex items-center justify-center transition">
                                                        -
                                                    </button>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="space-y-1 ">
                            ...
                            <?php elseif($orderType === 'take_away' && $editingTransactionId !== null): ?>
                                ...
                                <div
                                    class="col-span-4 grid grid-cols-3 divide-x divide-black/20 border-t border-black/10">
                                    <button type="button" wire:click="printBill"
                                        class="w-full flex items-center justify-center h-10 gap-2 text-white text-xs bg-brand-500 shadow-sm">
                                        <img src="/assets/icons/printer.png" width="14" height="14"
                                            alt="Print">
...
<div class="grid grid-cols-1 gap-2 p-2 md:grid-cols-12 animate-in fade-in duration-150" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'view-mode-payment'; ?>wire:key="view-mode-payment">
    ...
    <div class="md:col-span-9 space-y-1">
        ...
        <div class=" border bg-gray-100 rounded-sm">
            <div class="flex items-center justify-between p-2 ">
                ...
                <div class="flex items-center ">
                    <div class="flex items-center justify-between h-9  gap-1">
                        ...
                        <span class="text-xs font-bold text-gray-800 whitespace-nowrap"><?php echo e($paymentPage); ?>
            ...
            <div class="bg-white shadow-sm rounded-b-sm p-2 pb-40">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$cardSubMenuOpen): ?>
                    ...
                    <?php
                        $methods = [
                            ...
                            ['id' => 'compliment', 'name' => 'COMPLIMENT', 'color' => '#3C8DBC', 'text' => '#FFFFFF'],
                            ['id' => 'other', 'name' => 'OTHER COST', 'color' => '#3C8DBC', 'text' => '#FFFFFF'],
                        ];
                    ?>
                    <div class="grid grid-cols-6 gap-1 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4">
                    ...
                    <?php elseif($method['id'] === 'card'): ?>
                        wire:click="toggleCardSubMenu"
                    <?php elseif($method['id'] === 'other'): ?>
                ...
                <?php else: ?>
                    ...
                    ?>
                    <div class="grid grid-cols-6 gap-1 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cardMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <button type="button"
                                <?php if($method['action'] === 'card_detail'): ?> wire:click="toggleCardSubMenu"
                    <?php else: ?>
                        wire:click="$set('paymentMethod', '<?php echo e($method['id']); ?>'); $set('selectedPaymentLabel', '<?php echo e($method['name']); ?> Payment'); $set('paymentModalOpen', true);" <?php endif; ?>
                                class="group flex min-h-[150px] w-full flex-col items-center justify-center overflow-hidden rounded-xs border border-transparent shadow-sm hover:shadow-md hover:brightness-105 transition active:scale-95"
                                style="background-color: <?php echo e($method['color']); ?>;">
    ...
    <div class="md:col-span-3 space-y-1 ">
        ...
        <div class="overflow-hidden border border-gray-200 bg-white p-8 pb-15 pt-4 shadow-sm rounded-xs flex flex-col">
            <div
                ...
                <div class=" text-gray-700">
                    ...
                    <div class="flex justify-end gap-2">
                        <span>Subtotal</span>
                        <span class="tabular-nums  text-black"><?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
                    </div>
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <span class="tabular-nums text-black"><?php echo e(number_format($serviceAmount, 0, ',', '.')); ?></span>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($taxAmount > 0): ?>
                        <div class="flex justify-end gap-2">
                            <span>PB1 Total</span>
                            <span class="tabular-nums text-black"><?php echo e(number_format($taxAmount, 0, ',', '.')); ?></span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentCompliment > 0): ?>
                        <div class="flex justify-end gap-2 text-red-600 font-bold">
                            ...
                            <span class="tabular-nums">-<?php echo e(number_format($currentCompliment, 0, ',', '.')); ?></span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <div class="text-gray-700">
                    <div class="flex justify-end gap-2">
                        <span>Billing Total</span>
                        <span class="tabular-nums text-black"><?php echo e(number_format($total, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex justify-end gap-2">
                        <span>Voucher Purchase</span>
                        <span class="tabular-nums text-black">0</span>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($splitBills[$activeSplitTab]) && count($splitBills[$activeSplitTab]['items']) > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $splitBills[$activeSplitTab]['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sIdx => $sItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="flex items-center justify-between p-1  rounded-lg"
                                        <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'split-bill-'.e($activeSplitTab).'-'.e($sItem['variant_id'] ?? ($sItem['product_id'] ?? $sIdx)).''; ?>wire:key="split-bill-<?php echo e($activeSplitTab); ?>-<?php echo e($sItem['variant_id'] ?? ($sItem['product_id'] ?? $sIdx)); ?>">
                                        <div class="min-w-0 flex-1">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cancelTableModalOpen): ?>
    <template x-teleport="<?php echo e('body'); ?>">
        <div class="fixed inset-0 flex items-center justify-center p-4 z-[100020]">
            ...
            <div class="absolute inset-0 bg-black/40 backdrop-blur-xs" wire:click="$set('cancelTableModalOpen', false)">
            </div>
            ...
            <div
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 mb-1.5 uppercase tracking-wider">Cancel
                ...
                <div class="p-5 space-y-3 flex-1 overflow-y-auto">
                    ...
                    <div class="min-h-[180px]">
                        <?php
                            ...
                            $pagedMembers = $this->filteredMembers->forPage($memberListPage, $perPageMember)->values();
                        ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promotionModalOpen): ?>
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" x-data
        ...
        <div class="bg-white rounded-md shadow-xl w-[700px] max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div class="flex items-center justify-end px-5 py-2 border-t border-gray-100 text-xs text-gray-500 gap-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->promotions->hasPages()): ?>
                    ...
                    <button wire:click="previousPromotionPage"
                        ...
                        class="px-1 disabled:opacity-40">&lt;</button>
                    <button wire:click="nextPromotionPage" <?php echo e($this->promotions->hasMorePages() ? '' : 'disabled'); ?>
            ...
            <div
                ...
                <div
                    ...
                    <button wire:click="$set('voucherListPage', <?php echo e(max(1, $voucherListPage - 1)); ?>)"
                        ...
                        class="w-7 h-7 flex items-center justify-center border rounded disabled:opacity-30 hover:bg-gray-50">‹</button>
                    <button wire:click="$set('voucherListPage', <?php echo e(min($vouchers->lastPage(), $voucherListPage + 1)); ?>)"
                ...
                <div class="flex items-center justify-end gap-2 px-4 py-3 border-t border-gray-200 bg-gray-50 shrink-0">
