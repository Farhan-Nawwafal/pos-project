<div class="flex flex-col h-full">
    ...
    <?php elseif($orderType === 'take_away' || ($orderType === 'dine_in' && $selectedTableId)): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode === 'menu'): ?>
            <div class="grid grid-cols-1 gap-6 p-2 md:grid-cols-12" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'view-mode-menu'; ?>wire:key="view-mode-menu">
                        ...
                        <div class="bg-gray-50 border-t border-gray-200 shrink-0 p-2">
                            <div class="grid grid-cols-3 text-center items-center py-1">
                                <div>
                                    ...
                                    <p class="text-xs font-black text-black"><?php echo e($totalQty); ?></p>
                                </div>
                                <div>
                            ...
                            <div class="space-y-1 text-gray-700">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($taxAmount > 0): ?>
                                    <div class="flex justify-between">
                                        <span>PB1</span>
                                        <span
                                            class="tabular-nums text-gray-900"><?php echo e(number_format($taxAmount, 0, ',', '.')); ?></span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
            ...
            <div class="fixed inset-0 flex items-center justify-center p-4 z-[100030]" aria-modal="true" role="dialog">
                ...
                <div
                    ...
                    <div class="bg-[#337ab7] px-5 py-3 text-white">
                        <h3 class="text-base font-bold tracking-wide">Book Table (<?php echo e('Table ' . $tableToSelectLabel ?? 'Table 1'); ?>)</h3>
                    </div>
