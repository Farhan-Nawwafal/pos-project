    ...
    <div class="w-full">
        <div class="rounded-[28px] border border-white/60 bg-white/80 p-6 shadow-theme-lg backdrop-blur">
            ...
            <div class="mt-6 grid grid-cols-2 gap-3">
                ...
                <a
                    href="<?php echo e(route('self-order.scan')); ?>"
...
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\livewire\self-order\invalid.blade.php ENDPATH**/ ?>