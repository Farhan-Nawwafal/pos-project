<div x-data="{ activeTab: 'overview' }" class="flex flex-col">

    <div class="flex flex-col relative z-10">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-4">Sales Recapitulation</h2>
    ...
    <div x-show="activeTab === 'overview'" x-transition.opacity.duration.300ms class="grid grid-cols-1 gap-6">
        <div class="overflow-hidden rounded-2xl rounded-tl-none border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
...
<?php endif; ?>
    ...
    <div x-show="activeTab === 'online'" style="display: none;" x-transition.opacity.duration.300ms class="grid grid-cols-1 gap-6">

        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 text-center dark:border-gray-800 dark:bg-white/[0.03]">
