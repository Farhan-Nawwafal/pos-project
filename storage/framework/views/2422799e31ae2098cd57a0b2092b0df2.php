...
<html lang="id">
    <head>
        ...
        <title><?php echo e($brandName); ?></title>
    </head>
        ...
        <div class="mx-auto max-w-6xl px-4">
            <header class="flex items-center justify-between py-6">
                <a href="<?php echo e(route('landing')); ?>" class="flex items-center gap-3">
                    <img src="<?php echo e($brandLogoUrl); ?>" alt="<?php echo e($brandName); ?>" class="h-9 w-auto" />
                </a>
                <div class="hidden items-center gap-6 text-sm font-semibold text-gray-700 md:flex">
                    ...
                    <a href="<?php echo e($adminSignInUrl); ?>" class="hover:text-gray-900">Masuk Admin</a>
                    <a
                        href="<?php echo e($brandWhatsappUrl ?: $selfOrderDemoUrl); ?>"
                        target="<?php echo e($brandWhatsappUrl ? '_blank' : null); ?>"
                        rel="<?php echo e($brandWhatsappUrl ? 'noopener noreferrer' : null); ?>"
            ...
            <main class="pb-16">
                    ...
                    <div class="relative grid gap-12 px-6 py-12 md:grid-cols-2 md:px-10 md:py-14">
                        <div class="flex flex-col justify-center">
                            ...
                            <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                                ...
                                <a
                                    href="<?php echo e($selfOrderDemoUrl); ?>"
                                    ...
                                    <div class="overflow-hidden rounded-[28px] border border-gray-100 bg-white shadow-theme-lg">
                                        ...
                                        <div class="p-6">
                                            ...
                                            <div class="mt-4 flex flex-col gap-2 sm:flex-row">
                                                <a
                                                    href="<?php echo e($adminSignInUrl); ?>"
                ...
                <footer class="mt-14 pb-6">
                    <div class="flex flex-col gap-4 rounded-[28px] border border-white/60 bg-white/70 p-6 shadow-theme-sm backdrop-blur sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="leading-tight">
                                <div class="text-sm font-semibold text-gray-900"><?php echo e($brandName); ?></div>
                    ...
                    <div class="mt-4 text-center text-xs font-medium text-gray-500">
                        © <?php echo e(date('Y')); ?> <?php echo e($brandName); ?>. All rights reserved.
                    </div>
                </footer>
            </main>
        </div>
...
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\landing.blade.php ENDPATH**/ ?>