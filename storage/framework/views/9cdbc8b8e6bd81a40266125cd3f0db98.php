...
<div class="w-full bg-gray-200 mb-4">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($copyMenuModalOpen): ?>
        <div class="fixed inset-0 z-[100000] flex items-center justify-center p-4" aria-modal="true" role="dialog">
            <div class="absolute inset-0 bg-black/50" wire:click="$set('copyMenuModalOpen', false)"></div>
            <div
                class="relative w-full max-w-3xl overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900">
                <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                    <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">Copy Menu Antar Cabang</h3>
                    <button wire:click="$set('copyMenuModalOpen', false)"
                        class="text-gray-400 hover:text-gray-600">✕</button>
                </div>

                <div class="p-6 space-y-6">
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-400">Pilih Cabang
                            Sumber (Asal Menu)</label>
                        <select wire:model.live="sourceCabangId"
                            class="w-full rounded-lg border-gray-300 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <option value="">-- Pilih Cabang --</option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->cabangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cabang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sourceCabangId): ?>
                        <div class="border rounded-xl overflow-hidden dark:border-gray-800">
                            <div class="max-h-60 overflow-y-auto custom-scrollbar">
                                <table class="w-full text-sm text-left">
                                    <thead class="bg-gray-50 dark:bg-white/[0.03] sticky top-0">
                                        <tr>
                                            <th class="p-3 w-10">
                                                <input type="checkbox"
                                                    x-on:click="$el.checked ? $wire.set('selectedSourceProductIds', <?php echo \Illuminate\Support\Js::from($this->sourceProducts->pluck('id'))->toHtml() ?>) : $wire.set('selectedSourceProductIds', [])"
                                                    class="rounded border-gray-300 text-brand-500">
                                            </th>
                                            <th class="p-3 text-gray-500">Nama Menu</th>
                                            <th class="p-3 text-gray-500">Kategori</th>
                                            <th class="p-3 text-gray-500 text-right">Harga (Varian Terendah)</th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y dark:divide-gray-800">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->sourceProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sourceProd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <tr class="dark:text-gray-300">
                                                <td class="p-3">
                                                    <input type="checkbox" wire:model="selectedSourceProductIds"
                                                        value="<?php echo e($sourceProd->id); ?>"
                                                        class="rounded border-gray-300 text-brand-500">
                                                </td>
                                                <td class="p-3 font-medium"><?php echo e($sourceProd->name); ?></td>
                                                <td class="p-3"><?php echo e($sourceProd->category->name ?? '-'); ?></td>
                                                <td class="p-3 text-right">
                                                    Rp<?php echo e(number_format($sourceProd->variants->min('price'), 0, ',', '.')); ?>
                ...
                <div
                    ...
                    <button wire:click="copyMenu" <?php if(empty($selectedSourceProductIds)): echo 'disabled'; endif; ?>
                        class="px-4 py-2 text-sm font-semibold text-white bg-brand-500 rounded-lg hover:bg-brand-600 disabled:opacity-50">
                        Konfirmasi Copy (<?php echo e(count($selectedSourceProductIds)); ?> Menu)
                    </button>
                </div>
            </div>
        </div>
            ...
            <div
                ...
                <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
                    <div class="relative min-w-0 sm:w-[300px]">
                        ...
                        <input wire:model.live.debounce.400ms="categorySearch" type="text"
                    ...
                    <thead>
                        <tr class="border-b border-gray-200 dark:divide-gray-800 dark:border-gray-800">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['categories.edit', 'categories.delete'])): ?>
                                <th class="px-5 py-4 text-right text-xs font-medium text-gray-500 dark:text-gray-400">Aksi
                                </th>
                            <?php endif; ?>
                        </tr>
                    </thead>
                                ...
                                <td class="px-5 py-4">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editingCategoryId === (int) $category->id): ?>
                                        <div class="max-w-[420px]">
                                            <input wire:model.live="editingCategoryName" type="text"
                                    ...
                                    <div class="inline-flex items-center gap-2">
                                        ...
                                        <?php else: ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categories.edit')): ?>
                                                <button type="button"
                                                    wire:click="startEditCategory(<?php echo e((int) $category->id); ?>)"
                                                    class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03]">
                                                    Edit
                                                </button>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categories.delete')): ?>
                                                <button type="button"
                                                    x-on:click.prevent="$dispatch('confirm', { message: 'Hapus kategori ini?', method: 'deleteCategory', args: [<?php echo e((int) $category->id); ?>] })"
                                                    class="shadow-theme-xs inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03]">
                                                    Hapus
                                                </button>
                                            <?php endif; ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($createCategoryModalOpen): ?>
            <div class="fixed inset-0 z-[100000] flex items-center justify-center p-4" aria-modal="true"
                role="dialog">
                <div class="absolute inset-0 bg-black/50" wire:click="closeCreateCategoryModal"></div>
                <div
                    class="relative w-full max-w-xl overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-900">
                    <div
                        ...
                        <button type="button" wire:click="closeCreateCategoryModal"
                    ...
                    <form wire:submit="createCategory" class="space-y-4 p-5">
                        <div>
                            <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-gray-400">Nama
                                Kategori</label>
                            <input wire:model.live="categoryName" type="text"
                                aria-invalid="<?php echo e($errors->has('categoryName') ? 'true' : 'false'); ?>"
                                aria-describedby="<?php echo e($errors->has('categoryName') ? 'error-categoryName' : ''); ?>"
...
<<<<<<<< HEAD:storage/framework/views/06ce7094f50ddc9853f917837b9d1443.php
</div><?php /**PATH D:\POS PROJECT FINAL\pos-project\resources\views/livewire/products/products-page.blade.php ENDPATH**/ ?>
========
<?php /**PATH C:\Users\Idin Naufal Hakim\Desktop\project\pos-project\resources\views\livewire\products\products-page.blade.php ENDPATH**/ ?>
>>>>>>>> 77fab1855109285eb057b892225d4a691dd8446b:storage/framework/views/9cdbc8b8e6bd81a40266125cd3f0db98.php
