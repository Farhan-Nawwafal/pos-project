...
class UsersPage extends Component
{
    ...
    public ?int $editingCabangId = null;
    ...
    public function openCreateModal(): void
    {
        ...
        $this->reset(['name', 'email', 'role', 'isActive', 'password', 'passwordConfirmation', 'managerPin', 'cabangId']);
        $this->isActive = true;
    ...
    public function createUser(): void
    {
        ...
        $validated = $this->validate([
            ...
            'cabangId' => ['required', 'exists:cabangs,id'],
            'isActive' => ['boolean'],
    ...
    public function getAvailableCabangsProperty()
    {
        return Cabang::where('is_active', 'active')->get();
    }
    ...
    public function startEdit(int $userId): void
    {
        ...
        $this->editingCabangId = $user->cabang_id;
    ...
    public function closeEditModal(): void
    {
        ...
        $this->reset(['editingName', 'editingEmail', 'editingRole', 'editingIsActive', 'editingPassword', 'editingPasswordConfirmation', 'editingManagerPinIsSet', 'editingManagerPin', 'editingCabangId']);
        $this->resetValidation();
    }
    ...
    public function updateUser(): void
    {
        ...
        $validated = $this->validate([
            ...
            'editingCabangId' => ['required', 'exists:cabangs,id'],
        ...
        $user->forceFill([
            ...
            'cabang_id' => $validated['editingCabangId'],
