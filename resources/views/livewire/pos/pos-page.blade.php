<div class="flex flex-col h-full">
        ...
        <div class="flex flex-col flex-1 min-h-0 bg-white border border-gray-200 shadow-sm">
            ...
            <div class="flex items-center justify-between px-2 py-2 border-b border-gray-200">
                <div class="flex flex-wrap items-center gap-2">
                    <button type="button" wire:click="chooseOrderType('take_away')"
                        class="px-6 py-3 text-xs font-bold rounded-xs bg-[#1086e1] text-white">
                        Quick Service
                    </button>
                    <button type="button" wire:click="chooseOrderType('dine_in')"
                        class="px-6 py-3 text-xs font-bold rounded-xs bg-[#337ab7] text-white">
                        1 - 50
                    </button>
                    <button type="button" wire:click="chooseOrderType('dine_in')"
                        class="px-6 py-3 text-xs font-bold rounded-xs bg-[#337ab7] text-white">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button type="button"
                        class="w-9 h-9 flex items-center justify-center bg-[#337ab7] text-white rounded">
            ...
            <div class="flex items-center justify-between px-4 py-3 bg-gray-100 border-b border-gray-200">
                ...
                <button type="button" wire:click="openAddQuickService"
                    class="px-4 py-2 bg-[#337ab7] hover:bg-blue-700 text-white text-xs font-bold rounded flex items-center gap-1.5 transition active:scale-95">
                    + Add Quick Service
                </button>
            </div>
    ...
    @elseif ($orderType === 'take_away' || ($orderType === 'dine_in' && $selectedTableId))
        @if ($viewMode === 'menu')
            <div class="grid grid-cols-1 gap-6 p-2 md:grid-cols-12" wire:key="view-mode-menu">
                ...
                <div class="md:col-span-7 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-1">
                            @if ($orderType === 'dine_in' && $selectedTableId)
                                <h3 class="col-span-2 text-xs font-bold tracking-wide text-gray-500 dark:text-gray-400">
                                    Table:
                                </h3>
                            @else
                        ...
                        <div class="grid grid-cols-12 gap-2 items-center">
                            ...
                            <div class="col-span-10 flex items-center gap-1">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex items-center gap-2 shrink-0">
                                <div class="flex items-center justify-between h-11 px-2 gap-3">
                                    ...
                                    <span
                                        class="text-sm font-semibold text-gray-800 dark:text-white whitespace-nowrap">
                    ...
                    <div wire:init="loadVariantStockStatuses"
                        ...
                        @forelse ($displayProducts as $product)
                            ...
                            <button type="button" wire:click="addToCart({{ (int) $product['id'] }})"
                                class="group flex min-h-[110px] w-full flex-col items-center justify-center overflow-hidden rounded-xs border border-transparent shadow-sm hover:shadow-md hover:brightness-105 transition active:scale-95"
                                style="background-color: #F07600;">
                                <div
                                    class="text-center flex flex-col items-center justify-center gap-1 p-3 w-full h-full">
                    ...
                    <div class="space-y-2">
                        ...
                        @if ($orderType === 'dine_in' && $selectedTableId)
                            ...
                            <div class="grid grid-cols-3 w-full gap-1">
                                <button type="button" wire:click="$set('cancelTableModalOpen', true)"
                                    class="w-full h-10 text-xs font-bold text-white rounded-xs bg-red-500 shadow-sm">Cancel
                                    Table</button>
                                <button type="button" wire:click="saveAsPending" @disabled(count($cartItems) === 0)
                ...
                <div class="md:col-span-5 pt-3 space-y-3">
                    {{-- AREA SINKRONISASI TINGGI --}}
                    <div class="flex items-center gap-1">
                        <div class="w-[10%]">
                            <button type="button" wire:click="$set('deliveryCostModalOpen', true)"
                                class="w-full h-8 bg-brand-500 text-white text-xs font-bold rounded-sm hover:bg-blue-700 transition shadow-sm">uang</button>
                        </div>
                        <div class="w-[90%]">
                            <button type="button"
                    ...
                    <div
                        class="flex flex-col max-h-[540px] min-h-[540px] border border-gray-300 bg-white rounded-sm overflow-hidden shadow-sm">
                                        ...
                                        <div class="min-w-0 flex-1 flex justify-between items-start gap-2">
                                            ...
                                            <div class="flex flex-col gap-1 shrink-0">
                                                <button type="button" wire:click="removeItem({{ $idx }})"
                                                    class="w-8 h-6 bg-red-700 text-white text-[10px] rounded-xs font-bold hover:bg-red-800">X</button>
                                            </div>
                                        </div>
                                    </div>
                                @empty
                        ...
                        <div class="bg-gray-50 border-t border-gray-200 shrink-0 p-2">
                            <div class="grid grid-cols-3 text-center items-center py-1">
                                <div>
                                    <p class="text-[9px] font-bold text-gray-500 uppercase">Qty</p>
                                    <p class="text-xs font-black text-black">{{ $totalQty }}</p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-bold text-gray-500 uppercase">Subtotal</p>
                                    <p class="text-xs font-black text-black">Rp
                                        {{ number_format($subtotal, 0, ',', '.') }}</p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-bold text-gray-500 uppercase">Billing</p>
                                    <p class="text-xs font-black text-black">Rp
                    ...
                    {{-- AREA TOMBOL UTAMA BAWAH (INTERNAL ACTIONS) --}}
                    <div class="space-y-1.5 pt-1">
                        ...
                        <div class="grid grid-cols-4 gap-1 w-full">
                            <button type="button"
                                class="col-span-1 flex items-center justify-center h-10 font-bold text-white rounded-xs bg-brand-500 hover:bg-brand-600 shadow-sm transition active:scale-95">
                                <img src="/assets/icons/arrow-up.png" width="24" height="24" alt="Up">
                            </button>
                            <button type="button"
                                class="col-span-1 flex items-center justify-center h-10 font-bold text-white rounded-xs bg-brand-500 hover:bg-brand-600 shadow-sm transition active:scale-95">
                                <img src="/assets/icons/arrow-down.png" width="24" height="24"
                                    alt="Down">
                            </button>
                            <div class="col-span-2">
                                <button type="button" wire:click="saveAsPending" @disabled(count($cartItems) === 0)
                                    class="w-full h-10 font-bold text-white rounded-xs bg-brand-500 hover:bg-brand-600 shadow-sm transition text-xs tracking-wider">
                                    Save Order
                                </button>
                            </div>
                        </div>

                        {{-- BARIS 2: Print Bill, Split Bill, Payment — HANYA MUNCUL SAAT MENGEDIT PESANAN (SUDAH TERSIMPAN) --}}
                        @if ($isEditing)
                ...
                <div class="md:col-span-7 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-2 shrink-0">
                                <button type="button"
                                    class="h-11 px-3 flex items-center justify-center bg-gray-100 text-gray-800 text-xs font-semibold rounded-lg border border-gray-300 transition shadow-sm">Profile</button>
                                <button type="button"
                                    class="h-11 px-3 flex items-center justify-center bg-blue-600 text-white text-xs font-semibold rounded-lg transition shadow-sm">Check
                    ...
                    <div class="flex items-center justify-between pt-1">
                        ...
                        <div class="flex items-center gap-2">
                            <div
                                class="flex items-center justify-between h-9 bg-white border border-gray-300 rounded-lg px-2 shadow-sm gap-3">
                                <button type="button"
                                    class="p-1 rounded-md text-gray-500 hover:bg-gray-100 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <div
                        class="grid grid-cols-4 gap-1 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 bg-white shadow-sm rounded-lg p-2">
                        @php
                            $methods = [
                        ...
                        @foreach ($methods as $method)
                            <button type="button"
                                ...
                                @elseif ($method['id'] === 'card')
                                    wire:click="openCardPaymentModal"
                                @elseif ($method['id'] === 'other')
                                    wire:click="openOtherCostModal"
                                @else
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-4 bg-gray-50 p-4 rounded-xl border border-gray-200">
                        <div class="space-y-3">
                            <div>
                                <label
                                    class="block text-[11px] font-bold text-gray-600 uppercase tracking-wider mb-1">Voucher
                                    Purchase</label>
                            ...
                            <div>
                                <label
                                    class="block text-[11px] font-bold text-gray-600 uppercase tracking-wider mb-1">Total
                                    Payment</label>
                    ...
                    <div class="overflow-hidden border border-gray-200 bg-white shadow-sm rounded-xl flex flex-col">
                        <div
                            ...
                            <div class="space-y-1 text-gray-700">
                                ...
                                {{-- Service Charge hanya muncul kalau BUKAN quick service dan nilainya > 0 --}}
            ...
            @teleport('body')
                <div class="fixed inset-0 z-[100001] flex items-center justify-center p-4">
                    ...
                    <div class="absolute inset-0 bg-gray-900/60 backdrop-blur-sm"
                        wire:click="$set('voidItemModalOpen', false)">
                    </div>
    ...
    @if ($splitBillModalOpen)
        @teleport('body')
            <div class="fixed inset-0 z-[100015] flex items-center justify-center p-4">
                <div class="absolute inset-0 bg-gray-900/60 backdrop-blur-xs"
                    wire:click="$set('splitBillModalOpen', false)">
                </div>
                                    ...
                                    @if ($cItem['quantity'] > 0)
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center flex-1 min-w-0">
                                                <span
                                                    class="w-12 text-center text-sm font-bold text-gray-800 dark:text-white">{{ $cItem['quantity'] }}</span>
                        ...
                        <div class="w-1/2 flex flex-col p-4 bg-white dark:bg-gray-900">
                                    ...
                                    @foreach ($splitBills[$activeSplitTab]['items'] as $sIdx => $sItem)
                                        <div
                                            ...
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <p class="text-[11px] text-gray-500 mt-0.5">{{ $sItem['quantity'] }}x | @
                            ...
                            <div class="pt-3 flex justify-end">
                                <button type="button" wire:click="deleteSplitBill({{ $activeSplitTab }})"
                                    class="px-4 h-9 bg-red-500 hover:bg-red-600 text-white text-xs font-bold rounded shadow-sm flex items-center gap-1">
                                    🗑️ Delete Bill
                                </button>
                                @if (isset($splitBills[$activeSplitTab]) && count($splitBills[$activeSplitTab]['items']) > 0)
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button" wire:click="$set('splitBillModalOpen', false)"
                                class="h-10 px-5 bg-red-500 hover:bg-red-600 text-white text-xs font-bold rounded-lg shadow-sm flex items-center gap-1">
                                ✖ Close
                            </button>
                        </div>
                    </div>
        ...
        @teleport('body')
            <div class="fixed inset-0 flex items-center justify-center p-4 z-[100020]">
                ...
                <div
                    ...
                    {{-- Kolom Input Saling Terikat ke BE --}}
                    <div class="mt-2 mb-3">
                ...
                <div
                    ...
                    <div class="px-5 py-3 flex justify-end items-center gap-2">
                        <button type="button" wire:click="$set('phoneNumberModalOpen', false)"
                            class="h-10 px-5 border border-red-400 text-red-500 text-xs font-bold rounded hover:bg-red-50 transition active:scale-95">
                            Cancel
                        </button>
                        <button type="button" wire:click="$set('phoneNumberModalOpen', false)"
                ...
                <div
                    ...
                    <div class="px-5 py-3 border-t border-gray-100 flex justify-between items-center shrink-0">
                        <button type="button" wire:click="clearRegularMember"
                            class="h-10 px-4 bg-red-500 hover:bg-red-600 text-white text-xs font-bold rounded shadow-sm flex items-center gap-1.5 transition active:scale-95">
                ...
                <div
                    ...
                    <div class="px-5 py-3 border-t border-gray-100 flex justify-end items-center gap-2">
                        <button type="button" wire:click="$set('complimentModalOpen', false)"
                            class="h-10 px-5 bg-red-500 hover:bg-red-600 text-white text-xs font-bold rounded shadow-sm flex items-center gap-1.5 transition active:scale-95">
                            ✖ Cancel
                        </button>
